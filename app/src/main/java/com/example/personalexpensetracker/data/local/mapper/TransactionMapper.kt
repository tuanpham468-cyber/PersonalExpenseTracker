...
fun TransactionEntity.toDomain() = Transaction(id, amount, type, description, category, date)

fun Transaction.toEntity() = TransactionEntity(id, amount, type, description, category, date)